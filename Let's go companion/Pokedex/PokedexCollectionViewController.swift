...
class PokedexCollectionViewController: UICollectionViewController {
    ...
    var pokedexArray : Array<Dictionary<String, String>>!
    ...
    override func viewDidLoad() {
        ...
        pokedexArray = try! PropertyListSerialization.propertyList(from: pokedexData, options: [], format: nil) as! Array<Dictionary<String, String>>
